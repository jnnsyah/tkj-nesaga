...
export default function AdminSidebar({ isOpen, onClose }: AdminSidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed top-0 left-0 h-screen w-64 bg-primary text-secondary flex flex-col shrink-0 z-40 overflow-y-auto border-r border-secondary/10 transition-transform duration-300 ease-in-out",
      ...
      >
        ...
        <div className="p-6 border-b border-secondary/10">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={onClose}
              className="p-1.5 rounded-lg hover:bg-secondary/10 text-secondary/60 hover:text-secondary transition-colors lg:hidden"
            >
